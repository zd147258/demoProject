...
public class VerifyCodeUtils {
     ...
     */
    public static final String VERIFY_CODES = "123456789abcdefghjkmnpqrstuvwxyz";
    ...
    public static String generateVerifyCode(int verifySize, String sources){
        ...
        Random rand = new SecureRandom(String.valueOf(System.currentTimeMillis()).getBytes());
...
//        shear(g2, w, h, c);
    ...
    public static void main(String[] args) throws IOException{
        File dir = new File("/Users/luoyou/");
        int w = 200, h = 80;
