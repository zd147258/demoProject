...
/**
            ...
            if (userAgent.contains("Windows NT 6.2")) { //Windows 8
                ...
                return judgeBrowser(userAgent, "Windows", "10", null);
...
/**
            ...
            if (userAgent.contains("iPod")) {
                ...
                return judgeBrowser(userAgent, "Mac OS X", null, null);//判断浏览器

            }
        }
        return judgeBrowser(userAgent, "Other", "other", null);//判断浏览器
    }
